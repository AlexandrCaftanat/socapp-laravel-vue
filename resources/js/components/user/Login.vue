            ...
            <div class="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
                ...
                <div class="p-12 md:p-24">
                    <div class="flex items-center text-lg mb-6 md:mb-8">
                        ...
                        <input v-model="email" type="text" id="username" class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Username" />
                    </div>
                    <div class="flex items-center text-lg mb-6 md:mb-8">
                    ...
                    <button @click.prevent="login" class="bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full">Login</button>
                </div>
            </div>
        </div>
</template>
